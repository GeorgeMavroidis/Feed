...
@synthesize mainContent, mainImage, mainComposeScrollView;
...
//            screen_name.text = [user objectForKey:@"name"];
    ...
    UIImageView *bgImage = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"twitter_a6a6a6_100.png"]];
...
-(void)remove{
    ...
    UIScrollView* mySuperFrameView = (UIScrollView*)self.view.superview;
//    [mainComposeScrollView removeFromSuperview];
